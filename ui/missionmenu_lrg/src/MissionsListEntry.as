package
{
   ...
   public class MissionsListEntry extends BSScrollingTreeEntry
   {
      ...
      override public function SetEntryText(param1:Object) : void
      {
         ...
         if(!this.showingMission && Boolean(_loc2_))
         {
            this.ShowMission();
         }
         else if(!_loc2_)
      ...
      private function SetFactionIcon(param1:Object) : void
      {
         ...
         if(param1 != null)
         {
            QuestUtils.ShowFactionIcon(param1.iFaction,param1.iType,param1.strFactionIconName,this.factionIcon,this.factionIcon.CreationsFactionHolder_mc);
         }
         else
         {
            QuestUtils.ShowFactionIcon(FactionUtils.FACTION_NONE,QuestUtils.MISC_QUEST_TYPE,"",this.factionIcon,this.factionIcon.CreationsFactionHolder_mc);
         }
      }
