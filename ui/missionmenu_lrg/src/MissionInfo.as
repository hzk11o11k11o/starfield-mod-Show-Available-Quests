package
{
   ...
   public class MissionInfo extends BSDisplayObject
   {
      ...
      public var CreationsFactionHolder_mc:MovieClip;
         ...
         else
         {
            switch(param1)
            {
               ...
               case FactionUtils.FACTION_TRACKERSALLIANCE:
                  _loc4_ = getDefinitionByName("TrackersAllianceColorIcon") as Class;
                  break;
               case FactionUtils.FACTION_TERRANARMADA:
                  _loc4_ = getDefinitionByName("TerranArmadaColorIcon") as Class;
                  break;
               default:
      ...
      public function UpdateMissionInfo(param1:Object) : *
      {
         ...
         if(!param1.strFactionIconName || param1.strFactionIconName == "")
         {
            _loc3_ = GetQuestColorIcon(param1.iFaction,param1.iType);
            this.MissionFactionIcon_mc.addChild(_loc3_);
            this.CreationsFactionHolder_mc.alpha = 0;
         }
         else
         {
            this.CreationsFactionHolder_mc.alpha = 1;
            this.CreationsFactionHolder_mc.LoadSymbol(param1.strFactionIconName,param1.strFactionIconName);
         }
