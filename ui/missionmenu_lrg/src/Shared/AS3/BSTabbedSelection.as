package Shared.AS3
{
   ...
   public class BSTabbedSelection extends BSDisplayObject
   {
      ...
      protected var EntriesA:Array = new Array();
      ...
      protected var TabEntryClass:Class = getDefinitionByName("Shared.AS3.BSTabbedSelectionEntry") as Class;
      ...
      protected function PositionEntries() : void
      {
         ...
         {
            _loc7_ = this.GetClipByIndex(_loc3_);
            if(!_loc7_.LockedWidth)
            {
               _loc1_.push(_loc7_);
            }
            else
         ...
         while(_loc3_ < this.numTabs)
         {
            _loc10_ = this.GetClipByIndex(_loc3_);
            _loc10_.x = _loc6_;
