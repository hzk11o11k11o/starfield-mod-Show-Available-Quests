package Shared.AS3
{
   ...
   public class BSScrollingTree extends BSScrollingContainer
   {
      ...
      {
         var _loc2_:Object = entryList[param1];
         var _loc3_:Boolean = selectedIndex > param1;
      ...
      override public function MoveSelection(param1:int) : *
      {
         ...
         do
         {
            ...
            _loc5_ = GetClipByIndex(_loc2_,false);
            _loc3_ = _loc5_ ? _loc5_ as BSScrollingTreeEntry : null;
         }
      ...
      override public function onEntryRollover(param1:Event) : *
      {
         ...
         if(param1.currentTarget != null)
         {
            ...
            if(Boolean(_loc2_) && Boolean(_loc2_.IsEntryFocusable()) && (!this.navigateParentEntriesOnly || !this.IsClipAChild(_loc2_) || _loc2_.CanBeFocusedInParentEntriesOnly()))
            {
