   ...
   public class ButtonKeyHelper extends EventDispatcher
   {
      ...
      public function GetButtonNameForEvent(param1:String, param2:String = "") : String
      {
         ...
         if(param1 != "")
         {
            ...
            if(_loc4_.length > 1)
            {
               _loc6_ = GlobalFunc.NameToTextMap[(this.uiController > PlatformUtils.PLATFORM_PC_KB_MOUSE ? "" : "PC") + _loc4_[0]];
               _loc7_ = 1;
            ...
            {
               _loc6_ = GlobalFunc.NameToTextMap[(this.uiController > PlatformUtils.PLATFORM_PC_KB_MOUSE ? "" : "PC") + _loc3_];
            }
      ...
      public function GetButtonStringForEvents(param1:Array) : String
      {
         ...
         var _loc2_:String = this.GetMergedButtonString(param1);
         if(_loc2_ == "")
         {
            _loc3_ = "";
      ...
      private function GetMergedButtonString(param1:Array) : String
      {
         ...
         if(param1.length == 2 || param1.length == 4)
         {
            ...
            if(!_loc4_)
            {
               ...
               _loc9_ = GlobalFunc.NameToTextMap[(this.uiController > PlatformUtils.PLATFORM_PC_KB_MOUSE ? "" : "PC") + _loc7_];
               _loc2_ = _loc9_ != null ? _loc9_ : _loc2_;
            }
         }
         return _loc2_;
      }
