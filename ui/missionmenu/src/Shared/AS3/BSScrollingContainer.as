package Shared.AS3
{
   ...
   public class BSScrollingContainer extends BSDisplayObject
   {
      ...
      private var _entriesA:Array = new Array();
      
      private var _visibleEntriesA:Array = new Array();
      ...
      protected var EntryClass:Class = getDefinitionByName("Shared.AS3.BSContainerEntry") as Class;
      ...
      public function FindClipForEntry(param1:int) : BSContainerEntry
      {
         ...
         {
            _loc4_ = this.GetClipByIndex(_loc3_);
            if(_loc4_.itemIndex == param1)
            {
               _loc2_ = _loc4_;
               break;
            }
      ...
      protected function Update() : *
      {
         ...
         {
            _loc6_ = this.GetClipByIndex(this._listItemsShown,true);
            if(_loc6_)
            {
         ...
         {
            _loc7_ = this.GetClipByIndex(_loc4_);
            if(_loc7_)
            {
      ...
      public function SetSelectedByComparitor(param1:Function) : void
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.entryCount)
         {
            if(param1(this.entryList[_loc2_]))
            {
